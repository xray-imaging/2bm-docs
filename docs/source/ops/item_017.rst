...
.. _tomo6_parts: https://anl.box.com/s/qr2zcqzvwfveyp2k5wcy6d17epqbo1nk
.. _tomo6_quote: https://anl.box.com/s/9l8cafjr6k1252oln7ksmvj0le80vwee
...
+-----------+--------------------+------------------+-------------------+-------------------------------------------+------------------------+
| 2-BM      | tomo6              | 220U-MTNR-OTO-17 | `tomo6_parts`_    | Supermicro SYS-220U-MTNR Ultra 2U         | `tomo6_quote`_         |
+-----------+--------------------+------------------+-------------------+-------------------------------------------+------------------------+
...
Spare RAM modules on hand — **32 × Samsung 64 GB DDR4-3200 ECC RDIMMs**
(``M393A8G40AB2-CWEBY``):

+--------------+-----------+----------+--------------------+----------------------------+
| Manufacturer | # on hand | Capacity | Part Number        | Type / Speed               |
+==============+===========+==========+====================+============================+
| Samsung      | 32        | 64 GB    | M393A8G40AB2-CWEBY | DDR4-3200 ECC RDIMM, 2Rx4  |
|              |           |          |                    | (PC4-3200AA)               |
+--------------+-----------+----------+--------------------+----------------------------+
