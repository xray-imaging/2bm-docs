...
The following computers support detectors at 2-BM:
...
+-----------+--------------+-------------------+-----------------+--------------------------+---------------------+
| 2-BM-B    | tomdet       | Supermicro        | `SYS 521E WR`_  | `tomdet label`_          | `tomdet SM`_        |
+-----------+--------------+-------------------+-----------------+--------------------------+---------------------+

For each machine, the part list at purchase time and the list of supported
hardware can be obtained by entering the serial number on the `HP support
<https://partsurfer.hp.com/Search.aspx>`_ page.
...
The following cameras are currently in use at 2-BM:
...
Different combinations of camera, lens, and scintillator are possible,
providing flexibility in data-collection speed, pixel size, resolution, and
