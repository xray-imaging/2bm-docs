...
Different combinations of camera, lens, and scintillator screen are possible,
allowing for flexible data-collection speed, pixel size, resolution, and field
of view. Here are a few examples:

+-------------+-------------+---------------------------------+-----------+-----------------------------+----------------------------+------------------------+
|  Pixels (H) |  Pixels (V) | Detector pixel size (μm)        |  Lens mag |   Sample pixel size (μm)    |    H field of view (mm)    |  V field of view (mm)  |
+=============+=============+=================================+===========+=============================+============================+========================+
