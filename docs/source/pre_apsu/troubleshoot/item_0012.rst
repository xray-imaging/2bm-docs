...
+-----------+--------------------+--------------------------------+-------------------+----------------+----------------------------+------------------+------------------------+--------------------------------------------------------------------+
| 2-BM      | spindle            |             -                  | ABS2000-1000AS-RU | |00003|        | ENSEMBLEHLE10-40-A-MXH (*) |         6000     |            18          |  `ABRS-Hardware-Manual`_, `Spindle_ABS2000`_, `order 0004`_        |
+-----------+--------------------+--------------------------------+-------------------+----------------+----------------------------+------------------+------------------------+--------------------------------------------------------------------+
| 2-BM-A    | fast tomo          |     `Ensemble Settings`_       | ABS250MP-M-AS     | |00004|        | ENSEMBLEHLE10-40-A-MXH (*) |          500     |            66          |  `ABRS-Hardware-Manual`_, `ABRS_datasheet`_, `order 0005`_         |
+-----------+--------------------+--------------------------------+-------------------+----------------+----------------------------+------------------+------------------------+--------------------------------------------------------------------+
| 2-BM-B    | mona tomo          |     `Ensemble Settings`_       | ABRS-150MP-M-AS   | |00004|        | ENSEMBLEHLE10-40-A-MXH (*) |          500     |            8           |  `ABRS-Hardware-Manual`_, `order 0006`_                            |
+-----------+--------------------+--------------------------------+-------------------+----------------+----------------------------+------------------+------------------------+--------------------------------------------------------------------+
...
.. figure:: ../../img/sample_stack.jpg
   ...
   Sample stack as installed at 2-BM. From bottom to top: Aerotech
   HEX300-230HL hexapod, Kohzu SA16A-RM laminography tilt stage, and
   the Aerotech ABS250MP-M-AS air-bearing rotary at the top.
...
Details on the Position Synchronized Output (PSO) are in the `ABRS-Hardware-Manual`_


.. _ABRS-Hardware-Manual: https://anl.box.com/s/fcbrn0tv7jgrkxmreu4y54kj313q2grv
.. _ABRS_datasheet: https://anl.box.com/s/beje6d9h51ti1sukpd61ke7ow4qdqasj
.. _Spindle_ABS2000: https://anl.box.com/s/vw4rkyhfqwg7zlrerv1dhrtphfs86ndg
